...
typedef struct _THREADLESSCONFIG {
    HANDLE hProcess;
    PVOID pMainBuffer;
    DWORD dwMainBufferSize;
    PVOID pKannBuffer;
    DWORD dwKannBufferSize;
    PVOID pHookedFunction;
    PVOID pMainMemoryHole;
    PVOID pKannMemoryHole;
} THREADLESSCONFIG, *PTHREADLESSCONFIG;

typedef struct _TARGETFUNCTIONCONFIG {
    DWORD TargetProcess_Hash;
    DWORD HookFunction_Hash;
    DWORD HookFunctionDll_Hash;
    DWORD PayloadFunction_Hash;
    DWORD PayloadFunctionDll_Hash;
    DWORD dwMainBufferSize;
    DWORD dwKannBufferSize;
} TARGETFUNCTIONCONFIG, *PTARGETFUNCTIONCONFIG;
...
typedef enum _SYSTEM_INFORMATION_CLASS {
    ...
    SystemFileCacheInformationEx,    // q: SYSTEM_FILECACHE_INFORMATION; s
                                  // (requires SeIncreaseQuotaPrivilege) (same
                                  // as SystemFileCacheInformation)
    ...
    SystemPagedPoolInformationEx,      // q: SYSTEM_FILECACHE_INFORMATION; s
    ...
    SystemSecurityModelInformation, // SYSTEM_SECURITY_MODEL_INFORMATION //
                                    // since 19H1
